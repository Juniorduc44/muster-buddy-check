          ...
          <div className="mt-4">
            ...
            <div className="space-y-2 mt-4">
              ...
              <Button
                ...
                disabled={loading}
                className="w-full bg-white hover:bg-gray-100 text-gray-900 border-gray-300 font-semibold"
              >
              ...
              <Button
                ...
                className="w-full border-pink-600 text-pink-400 hover:bg-pink-900/20 hover:border-pink-500"
              >
